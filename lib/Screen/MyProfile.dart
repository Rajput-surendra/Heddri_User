...
import 'package:eshop_multivendor/Screen/planPage.dart';
...
import 'my_member_ship_plan.dart';
              ...
              Column(
                ...
                children: [
                  ...
                  Consumer<SettingProvider>(builder: (context, SettingProvider, _) {
                    return SettingProvider.userName == ""
                        ? Padding(
  ...
  _getDrawer() {
    return ListView(
      ...
      children: <Widget>[
        ...
        CUR_USERID == "" || CUR_USERID == null
            ? Container()
            : _getDrawerItem(getTranslated(context, 'PLAN')!,
            'assets/images/pro_wh.svg'),
        CUR_USERID == "" || CUR_USERID == null
            ? Container()
            : _getDrawerItem(getTranslated(context, 'MEMBER_SHIP_PNAN_MY')!,
            'assets/images/pro_wh.svg'),
        // CUR_USERID == "" || CUR_USERID == null ? Container() : _getDivider(),
        CUR_USERID == "" || CUR_USERID == null
            ? Container()
    ...
    return Card(
      ...
      child: ListTile(
        ...
        onTap: () {
          ...
          else if (title == getTranslated(context, 'PLAN')) {
            Navigator.push(
                context,
                MaterialPageRoute(
          ...
          else if (title == getTranslated(context, 'MEMBER_SHIP_PNAN_MY')) {
            Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => MyMemberShipPlan(),
                ));
          }
